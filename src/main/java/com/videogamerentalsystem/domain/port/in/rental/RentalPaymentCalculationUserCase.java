...
public interface RentalPaymentCalculationUserCase {
     ...
     * @param gameInventoryModel The set of game inventory models associated with the rental.
     */
    void applyAndCalculateRentalCost(RentalModel rentalModel, Set<GameInventoryModel> gameInventoryModel);
