...
public interface RentalLoyaltyUserCase {
     ...
     *
     * @param productModels The set of rental product models for which to calculate loyalty points.
     * @return The total loyalty points calculated.
     */
    Integer calculateTotalPoints(Set<RentalProductModel> productModels);
}